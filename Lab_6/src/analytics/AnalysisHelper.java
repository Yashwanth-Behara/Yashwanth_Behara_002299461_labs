...
public class AnalysisHelper {
    ...
    public void getMaxLikeCommentPost() {
        ...
        System.out.println("Q2 - ID of the post with most likes per comment: " + data.getPosts().get(postId).getPostId());
    }
    ...
    public void getPostWithMostComments() {
        ...
        System.out.println("Q3 - ID of the post with most comments: " + postWithMostComments.getPostId());
    }
    ...
    public void getPassiveUsers() {
        ...
        for (int i = 0; i<5; i++) {
            System.out.println(users.get(i) + ", - Total posts: " + postNumbers.get(users.get(i).getId()));
        }
    ...
    public void getPassiveCommentUsers() {
        ...
        for (int i=0; i<5; i++) {
            System.out.println(users.get(i) + ", - Total comments: " + commentNumbers.get(users.get(i).getId()));
        }
    }
    ...
    public void getPassiveAndActiveOverallUsers() {
        ...
        // Adding the total comments & likes to the overallNumbers Hash map
        for (Comment c : data.getComments().values()) {
             int userId = c.getUserId();
        ...
        // Adding the total posts to the overallNumbers Hash map
        for (Post p : data.getPosts().values()) {           
            int userId = p.getUserId();
            if (overallNumbers.containsKey(userId)) {
